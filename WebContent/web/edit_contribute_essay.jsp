	...
	<div class="workdesk_body">
		...
		<div class="main contribute">
			...
			<div class="upload">
				...
				<div class="upload_content">
					<span id="originalTip" class="onShow">英文关键词<b><font color="red">(*)</font></b></span>
				...
				<div class="upload_content">
					...
					<%-- <c:if test="${essay.styleId !=0}">
					<input type="hidden" name="" value="${essay.styleId}"/>
					<input class="btn_content" type="text" name="" value="${essay.essayStyle.styleName}">
					</c:if> --%>
					<select name="styleId" style="width:41%">
				...
				<div class="linkcss">
					<input class="linkbtn" type="button" value="更新&保存" id="update_essaybtm" />
...
$(function() {
	...
	$("#contribute_essaybtm").click(function (){
		...
		$.ajax({
            ...
            success : function(msg) {
            	alert("投稿成功")
             	location.href='../essay/selectEssayByUsernameAndStatusId.do?statusId=61&pageCode=1';
            } 
         });
	});
	//btnReturn
