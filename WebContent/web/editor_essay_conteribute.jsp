							...
							<table width="963">
								...
								<tr>							
									...
									<c:if test="${cEssay.essay.statusId eq 62}">
										<td>
											<font color="red">专家审核中...</font>
										</td>
										<td>
											<a href="" title="点击提醒专家审核"><font color="red">提醒</font></a>
										</td>
									</c:if>
									<c:if test="${cEssay.essay.statusId eq 63}">
										...
										<td>
											<a href="../editor/selectECommentById.do?essayId=${cEssay.essayId}" title="点击审核稿件评审"><font color="blue">编辑审核</font></a>
										</td>
									</c:if>
									<c:if test="${cEssay.essay.statusId == 66 || cEssay.essay.statusId == 67 || cEssay.essay.statusId == 68}">
										<td>
											<font color="green"><b>编辑已审核</b></font>
										</td>
										<td>		
											<a href="../editor/selectECommentById.do?essayId=${cEssay.essayId}" title="查看稿件审稿评审"><font color="blue">查看审核结果</font></a>
										</td>
									</c:if>
								...
								<tbody>
									<tr valign="top">
										...
										<td align="right" width="325" style="margin-right: 50px;">
											...
											<a href="../editor/selectContributeEssay.do?pageCode=1">首页</a>
											<c:if test="${pageInfo.hasPreviousPage }">
												<a href="../editor/selectContributeEssay.do?pageCode=${pageInfo.prePage}">上一页</a>
											</c:if>
											<c:if test="${pageInfo.hasNextPage }">
											<a href="../editor/selectContributeEssay.do?pageCode=${pageInfo.nextPage}">下一页</a>
											</c:if>
											<a href="../editor/selectContributeEssay.do?pageCode=${pageInfo.pages}">尾页</a> 
										</td>
										<td>
...
<script type="text/javascript">
	...
	$('#jumpBtn').click(function(){
		...
		if(pageCode==''||pageCode>pages){
			...
			location.href = "../editor/selectContributeEssay.do?pageCode="+pageCode;
