		...
		<table width="60%" align="center"
			...
			<tbody>
				...
				<tr>
					...
					<td style="width: 10%; height: 20px;" colspan="2"><fmt:formatDate  value="${essay.contributeDate}" type="both" pattern="yyyy.MM.dd"/></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td style="width: 10%; height: 20px;" valign="middle" colspan="4">
						<c:if test="${not empty eComment.designCommentId}">
							<input type="hidden" name="designCommentId" value="${eComment.designCommentId}">
							<input type="radio" name="designCommentId" value="${eComment.designCommentId}" checked>
				...
				<tr>
					...
					<td style="width: 10%; height: 20px;" valign="middle" colspan="4">
						<c:if test="${not empty eComment.designCommentId}">
							<input type="hidden" name="contentCommentId" value="${eComment.contentCommentId}">
							<input type="radio" name="contentCommentId" value="${eComment.designCommentId}" checked>
				...
				<tr>
					...
					<td style="width: 10%; height: 20px;" valign="middle" colspan="4">
						<c:if test="${not empty eComment.designCommentId}">
							<input type="hidden" name="dataCommentId" value="${eComment.contentCommentId}">
							<input type="radio" name="dataCommentId" value="${eComment.designCommentId}" checked>
				...
				<tr>
					...
					<td style="width: 10%; height: 20px;" valign="middle" colspan="4">
						<c:if test="${not empty eComment.designCommentId}">
							<input type="hidden" name="discussCommentId" value="${eComment.discussCommentId}">
							<input type="radio" name="discussCommentId" value="${eComment.designCommentId}" checked>
				...
				<tr>
					...
					<td style="width: 10%; height: 20px;" valign="middle" colspan="4">
						<c:if test="${not empty eComment.designCommentId}">
							<input type="hidden" name="resultCommentId" value="${eComment.resultCommentId}">
							<input type="radio" name="resultCommentId" value="${eComment.designCommentId}" checked>
...
$('#btnReturn').click(function(){
	location.href="../editor/selectPreHandleEssay.do?statusId=62&pageCode=1";
});
</script>
</body>
</html>
