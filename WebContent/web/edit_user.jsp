	...
	<form id="formUser">
		...
		<div class="register_box">
			<div class="register_title">
				...
				<span class="span_title" >编辑管理员   &nbsp;&nbsp;&nbsp;&nbsp;修改--期刊稿在线处理系统 </span>
			...
			<div class="register_content">
				...
				<div class="notice_info" style="border-bottom: none;">
					(1) 完成注册共有两个页面. 每个标记为(必须)的项目必须如实填写. 填写完成后, 请点击"下一步"按钮
				</div>
					...
					<table class="register_table">
						...
						<tr>
							...
							<td class="table_td_right" colspan="2" rowspan="2" align="left">
								<input class="input_text" type="text" name="username" id="username" value="${user.username}">
								<!--用户名格式错误信息提示-->
						...
						<tr>
							...
							<td class="table_td_right" colspan="2" rowspan="2" align="left">
								<input class="input_text" type="text" name="password" id="password" value="${user.password}">
								<!--密码格式错误信息提示-->
						...
						<tr>
							...
							<td class="table_td_right" align="left">
								<input class="input_text" type="text" name="rePassword" id="rePassword" value="${user.password}">
								<!--确认密码格式错误信息提示-->
								<span class="span_red"><font color="red">(*)</font></span>
						...
						<tr>
							...
							<td class="table_td_right" colspan="2" rowspan="2" align="left">
								<input class="input_text" type="text" name="email" id="email" value="${user.email}">
								<!--密码格式错误信息提示-->
								<span class="span_red"><font color="red">(*)</font></span>
						...
						<tr>
							...
							<td class="table_td_right" colspan="2" rowspan="2" align="left">
								<input class="input_text" type="text" name="trueName" id="trueName" value="${user.trueName}">
								<!--用户名格式错误信息提示-->
								<span class="span_red"><font color="red">(*)</font></span>
						...
						<tr>
							...
							<td class="table_td_right" colspan="2" rowspan="2" align="left">
								<input class="input_text" type="text" name="profession" id="profession" value="${user.profession}">
								<br>
								<br />
						...
						<tr>
							...
							<td class="table_td_right" colspan="2" align="left">
								<textarea style="width: 450px; height: 69px;" rows="4" cols="20" name="research" id="research">${user.research}</textarea>
								<span class="span_red"><font color="red">(*)</font></span>
						...
						<tr>
							...
							<td class="table_td_right" colspan="2" rowspan="2" align="left">
								<select name="postId" id="postId" style="width:45%">
									<option value="${user.postId}">${user.post.postId}</option>
						...
						<tr>
							...
							<td class="table_td_right" colspan="2" rowspan="2" align="left">
								<select name="eBackgroundId" id="eBackgroundId" style="width:45%">
									<option value="${user.eBackgroundId}">${user.eBackground.eBackgroundName}</option>
						...
						<tr>
							...
							<td class="table_td_right" colspan="2" rowspan="2" align="left">
								<input class="input_text" type="text" name="workUnit" id="workUnit" value="${user.workUnit}">
								<span class="span_red"><font color="red">(*)</font></span>
						...
						<tr>
							...
							<td class="table_td_right" colspan="2" rowspan="2" align="left">
								<input class="input_text" type="text" name="address" id="address" value="${user.address}">
								<!--用户名格式错误信息提示-->
								<span class="span_red"><font color="red">(*)</font></span>
								<span id="workUnitMsg"></span><br>
						...
						<tr>
							...
							<td class="table_td_right" colspan="2" rowspan="2" align="left">
								<input class="input_text" type="text" name="postcode" id="postcode" value="${user.postcode}">
								<!--用户名格式错误信息提示-->
								<span class="span_red"><font color="red">(*)</font></span>
						...
						<tr>
							...
							<td class="table_td_right" colspan="2" rowspan="2" align="left">
								<input class="input_text" type="text" name="phone" id="phone" value="${user.phone}">
								<br>
						...
						<tr>
							...
							<td class="table_td_right" colspan="2" rowspan="2" align="left">
								<input class="input_text" type="text" name="telephone" id="telephone" value="${user.telephone}">
								<!--用户名格式错误信息提示-->
								<span class="span_red"><font color="red">(*)</font></span>
...
         }
	...
	$('#bt-reg').click(function(){
	    //异步提交请求，进行验证
	    var applyExpert=$(".applyExpert").val();
	    var url;
	    var href;
	    if(applyExpert==0){
	    	//否
	    	url="../user/register.do";
	    	href="../user/showLogin.do"
	    }else{
	    	//申请为专家
	    	url="../professor/register.do";
	    	href="../professor/showLogin.do"
	    }
	    $.ajax({
	    	url:url,
	    	data:"username="+$("#username").val()+
		    	 ...
		    	 "&postId="+$("#postId").val()+
		    	 "&eBackgroundId="+$("#eBackgroundId").val()+
		    	 "&workUnit="+$("#workUnit").val()+
		    	 "&address="+$("#address").val()+
		    	 "&postcode="+$("#postcode").val()+
		    	 "&phone="+$("#phone").val()+
		    	 "&telephone="+$("#telephone").val()+
		    	 "&applyExpert="+$(".applyExpert").val(),
	    	type:"post",
	    	dataType : "json",
	    	success:function(obj){
	    		if(obj.state==0){
