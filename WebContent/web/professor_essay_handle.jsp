						...
						<c:if test="${pageInfo.list!=null}">
							<table width="970">
								<tr>
									...
									<th style="width: 5%;">稿件作者</th>
									<th style="width: 10%;">关键词</th>
									<th style="width: 10%;">投稿人</th>
									<th style="width: 10%;">稿件状态</th>
									<th style="width: 10%;">分配时间</th>
									<th style="width: 15%;">稿件操作</th>
								</tr>
							...
							<%-- 	<input type="hidden" name="statusId" id="statusId" value="${statusId}"> --%>
								<tr>
									...
									<c:if test="${cEssay.essay.statusId eq 63}">
										<td><font color="red">已审核</font></td>
									</c:if>
									<td><fmt:formatDate  value="${cEssay.contributeDate}" type="both" pattern="yyyy.MM.dd"/></td>
									<td>
										<a href="" title="点击审核稿件">审核详情</a>
										<!-- <a href="#" title="点击退理审核">退审</a> -->
									</td>
								</tr>
							</c:forEach>
							</table>
