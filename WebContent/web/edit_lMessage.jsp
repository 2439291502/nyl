...
$(function(){
		...
		if(lMessageContent.length>0){
			...
			$.ajax({
				...
				success : function(obj) {
					if(obj.state==1){
						alert(obj.message);
						location.href="../lMessage/editLMessage.do";
					}else{
	...
	$('#saveLMessage').click(function(){
		...
		if(lMessageContent.length>0){
			...
			$.ajax({
				type : 'POST',
				url : '../lMessage/updateLMessage.do',
				data : data,
				success : function(obj) {
					if(obj.state==1){
						alert(obj.message);
		...
		<div class="workdesk_main">
			...
			<div class="main">
				...
				<div class="work_left">
					...
					<div class="linkcss">
					<input type="button" id="btnSendLMessage" value="发送消息">
					<input type="button" id="saveLMessage" value="更新&保存">
